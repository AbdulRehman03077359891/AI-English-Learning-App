...
import 'package:ai_english_learning/Screen/Admin/add_exams.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:ai_english_learning/Controllers/fire_controller.dart';
import 'package:ai_english_learning/Screen/Admin/add_classes.dart';
import 'package:ai_english_learning/Screen/Admin/add_levels.dart';
import 'package:ai_english_learning/Screen/Admin/admin_view_levels.dart';
import 'package:ai_english_learning/Screen/Admin/personal_data.dart';
...
accountName: Text(widget.accountName, style: const TextStyle(fontWeight: FontWeight.bold,shadows: [BoxShadow(color: Color.fromARGB(115, 24, 255, 255),blurRadius: 3,spreadRadius: 3)]),),
              accountEmail: Text(widget.accountEmail, style: const TextStyle(fontWeight: FontWeight.bold,shadows: [BoxShadow(color: Color.fromARGB(115, 24, 255, 255),blurRadius: 3,spreadRadius: 3)]),),
            ),
            ..._buildSlidingTiles(),
          ],
        ),
  ...
  List<Widget> _buildSlidingTiles() {
    final tiles = [
      ...
      },
      {
        'icon': Icons.logout,
        'title': "Log Out",
        "onPress": () => showConfirmationDialog(context,() => fireController.logOut())
      },
    ];
